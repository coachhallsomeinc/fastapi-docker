...
def get_heroes(db: Session):
    ...
    for hero in heroes_with_abilities:
        ...
        friends = (
            ...
            .join(FriendAlias, and_(Hero.id == hid,
    ...
    return friends
        ...
        # enemies = (
        #     db.query(Hero, EnemyAlias, RelationshipType)
        ...
        # for enemy, relationship_type in enemies:
        #     relationship_type_model = RelationshipTypeModel(
        #         id=enemy.relationship_type.id,
        #         name=enemy.relationship_type.name
        #     )
        ...
        #         relationship_type=relationship_type_model  # Include the RelationshipTypeModel instance
        #     )
        #     # Append the enemy_model to the corresponding hero's enemies list
        #     heroes[hero.id].enemies.append(enemy_model)
